...
public class UserActivityMapper extends
		Mapper<LongWritable, Text, IntWritable, UserActivityVO> {
	...
	protected void map(
		...
		if (columns != null && columns.length > 2) {
			...
			context.write(new IntWritable(userActivityVO.getUserId()),
					userActivityVO);
		}
	}
	...
	private void loadUserInMemory(
		...
		try {
			...
			br = new BufferedReader(new FileReader("user.log"));
			String line;
